...
Your agent reads [`AGENTS.md`](AGENTS.md) in this repository, which points at the
organization's [`AGENTS.md`](https://github.com/scalameta/.github/blob/main/AGENTS.md). The
section "Contributing with agents" of the organization's guide applies to you and to the agent.
